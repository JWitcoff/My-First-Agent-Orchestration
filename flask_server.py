...
# Import your existing travel agent code
# Make sure your Travel_Agent.py file is in the same directory
try:
...
def index():
    ...
    possible_files = ['travel_frontend.html', 'frontend.html', 'index.html']
    
    for filename in possible_files:
        try:
            with open(filename, 'r') as f:
                print(f"✅ Serving frontend from: {filename}")
                return f.read()
        except FileNotFoundError:
            continue
    
    # If no HTML file found, show basic info page
    return """
    <!DOCTYPE html>
    <html>
    <head>
    ...
    <body>
        <div class="container">
            <h1>🚀 Travel Agent API Server</h1>
            <div class="status">✅ Backend is running successfully!</div>
            
            <h2>📋 Setup Instructions:</h2>
            <ol>
                <li>Save the frontend HTML file as <code>travel_frontend.html</code> or <code>frontend.html</code></li>
                <li>Put it in the same directory as this Flask server</li>
            ...
            <div class="endpoints">
                <h2>🔧 API Endpoints:</h2>
                <ul>
                    <li><strong>GET /</strong> - This page / Frontend interface</li>
                    <li><strong>POST /api/plan-trip</strong> - Plan a complete trip</li>
                    <li><strong>GET /api/test</strong> - Test the API connection</li>
                </ul>
                
                <h3>🧪 Test the API:</h3>
                <p>Try: <code>curl http://localhost:8000/api/test</code></p>
            </div>
            
            <p><strong>Current directory files checked:</strong> travel_frontend.html, frontend.html, index.html</p>
        </div>
    </body>
    </html>
    """
...
if __name__ == '__main__':
    ...
    print("=" * 50)
    print("💡 Make sure you have 'travel_frontend.html' in the same directory!")
    print("=" * 50)
